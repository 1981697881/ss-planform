...
export default {
  ...
  methods: {
    ...
    async changeUser(val) {
      ...
      /*if (this.listInfo) {*/
      this.fetchData2({ftype: 1,fposition: this.form.femp, fannual: this.form.fannual.slice(0, 4)})
      this.fetchData({ftype: 1,femp: this.form.femp, fannual: this.form.fannual.slice(0, 4)})
      /*}*/
    },
    importData() {
      this.visible = true
